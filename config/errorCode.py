def errors(err_code):
    err_dic = {0 : ('OP_ERR_NONE', '정상처리'),
                ...
                -106 : ('OP_ERR_SOKECT_CLOSED', '통신연결종료'),
                -200 : ('OP_ERR_SISE_OVERFLOW', '시세조회과부하'),
                -201 : ('OP_ERR_AQ_STRUCT_FAIL', '전문작성초기화실패'),
                -202 : ('OP_ERR_AQ_STRING_FAIL', '전문작성입력값오류'),
                ...
                -305 : ('OP_ERR_MIS_1PER_EXC', '주문수량이총발행주수의 1% 초과오류'),
                -306 : ('OP_ERR_MIS_3PER_EXC', '주문수량이총발행주수의 3% 초과오류'),
